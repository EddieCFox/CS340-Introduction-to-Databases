...
CREATE TABLE category_tbl (
	...
	CONSTRAINT subcategory_combination UNIQUE (name, subcategory)
...
CREATE TABLE operating_system (
	...
	CONSTRAINT version_combination UNIQUE (name, version)
) ENGINE = InnoDB DEFAULT CHARSET = utf8;
...
INSERT INTO device (cid, name, received, isbroken)
	SELECT id, 'Samsung Atlas', '1970-01-02', true 
	FROM category_tbl
...
INSERT INTO device (cid, name, received, isbroken)
	SELECT id, 'Nokia', '1999-05-06', false 
	FROM category_tbl
...
INSERT INTO device (cid, name, received, isbroken)
	SELECT id, 'jPad', '2005-11-18', false 
	FROM category_tbl
...
INSERT INTO os_support (did, osid) VALUES ((SELECT id FROM device WHERE name = 'Samsung Atlas'), (SELECT id FROM operating_system WHERE name = 'Android' AND version = '2.0'));

-- device: jPad
-- os: iOS 4.0
-- notes: NULL

INSERT INTO os_support (did, osid) VALUES ((SELECT id FROM device WHERE name = 'jPad'), (SELECT id FROM operating_system WHERE name = 'iOS' AND version = '4.0'));